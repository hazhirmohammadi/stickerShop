...
const ProductDetails = () => {
   ...
   return (
       <div
           className="mt-3 mb-3 bg-gray-900 flex flex-col rounded-3xl align-middle justify-center items-center md:flex-row md:items-start space-y-8 md:space-y-0 md:space-x-4 lg:space-x-8 max-w-6xl w-11/12 mx-auto">
          {product ? (
              <>
                 <Helmet>
